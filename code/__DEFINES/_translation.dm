...
#define PLUR_HOURS_LEFT(hours) pluralize_russian(hours, "час", "часа", "часов")  // "Остался 1 час". Не путайте с нижним.
#define PLUR_HOURS_IN(hours) pluralize_russian(hours, "час", "часа", "часов")  // "Через 1 час". Не путайте с верхним.
