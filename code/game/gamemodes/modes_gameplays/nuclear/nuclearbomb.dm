...
/obj/item/weapon/disk/nuclear
	...
	cases = list("дискета ядерной аутентификации", "дискеты ядерной аутентификации", "дискете ядерной аутентификации", "дискету ядерной аутентификации", "дискетой ядерной аутентификации", "дискете ядерной аутентификации")
...
/obj/item/weapon/disk/nuclear/process()
	...
	if(!is_centcom_level(disk_loc.z) && !is_station_level(disk_loc.z))
		to_chat(get(src, /mob), "<span class='danger'>Невозможно не чувствовать, что ты там что-то потерял...</span>")
		qdel(src)
